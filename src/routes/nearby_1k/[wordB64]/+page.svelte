...
<div class="mb-4 rounded px-2 pb-4 pt-6">
	...
	<h1 class="text-md font-rubik my-4 sm:text-xl">
		Sanaa <span class="font-bold">"{decodeB64word(wordB64)}"</span> lähimmät sanat:
	</h1>
		...
		<table class="font-base all-guesses w-full rounded-b-3xl text-sm sm:text-base">
			<thead>
				<tr class="bg-[#dad3f1] dark:bg-[#201029]">
					<th class="rounded-tl-2xl py-2">#</th>
					<th style="text-align: left;">Sana</th>
					<th class="rounded-tr-2xl" style="text-align: left;">Pisteet</th>
				</tr>
			</thead>
			<tbody>
